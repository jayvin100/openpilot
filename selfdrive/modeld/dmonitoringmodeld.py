...
def parse_model_output(model_output):
  ...
  for ds_suffix in ['lhd', 'rhd']:
    ...
    for key in ['face_prob', 'left_eye_prob', 'right_eye_prob','left_blink_prob', 'right_blink_prob', 'sunglasses_prob', 'using_phone_prob', 'seatbelt_unlatched_prob']:
...
def fill_driver_data(msg, model_output, ds_suffix):
  ...
  msg.seatbeltUnlatchedProb = model_output[f'seatbelt_unlatched_prob_{ds_suffix}'][0, 0].item()
